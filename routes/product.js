...
router.get("/getBanners",async (req, res) => {
  var banners = ["www.grocamie.com/img/Banner1@2x.png", "www.grocamie.com/img/Banner2@2x.png", "www.grocamie.com/img/Banner3@2x.png", "www.grocamie.com/img/Banner4@2x.png"]
  res.send(banners);
});
